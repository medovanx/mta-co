...
namespace MTA.Game.Items.Handlers {
    ...
    [ItemHandler(
        ...
        SkillCriticalStrikePrimaryPackBacksword, SkillCriticalStrikeMediumPackBacksword,
        SkillCriticalStrikeSuperiorPackBacksword,
        SkillCriticalStrikePrimaryPackBracelet, SkillCriticalStrikeMediumPackBracelet,
        SkillCriticalStrikeSuperiorPackBracelet,
        // Block
        ...
        RefineryPack724130, RefineryPack724131, RefineryPack724132, RefineryPack724133, RefineryPack724134,
        RefineryPack724135,
        RefineryPack724151, RefineryPack724152, RefineryPack724153, RefineryPack724154, RefineryPack724155,
        RefineryPack724156,
        RefineryPack724157, RefineryPack724158, RefineryPack724159, RefineryPack724160, RefineryPack724161,
        RefineryPack724162,
        RefineryPack724163, RefineryPack724164, RefineryPack724165, RefineryPack724166, RefineryPack724167,
        RefineryPack724168,
        RefineryPack724169, RefineryPack724170, RefineryPack724171, RefineryPack724172, RefineryPack724173,
        RefineryPack724174,
        RefineryPack724175, RefineryPack724176, RefineryPack724177, RefineryPack724178, RefineryPack724179,
        RefineryPack724180,
        RefineryPack724181, RefineryPack724182, RefineryPack724183, RefineryPack724184, RefineryPack724185,
        RefineryPack724186,
    ...
    public static class RefineryPackHandler {
        private static readonly Dictionary<uint, int> ItemOffsets = new Dictionary<uint, int> {
            ...
            { PenetrationPrimaryPackBracelet, 1260 }, { PenetrationMediumPackBracelet, 1260 },
            { PenetrationSuperiorPackBracelet, 1260 },
            // Penetration - Headgear
            { PenetrationPrimaryPackHeadgear, 696 }, { PenetrationMediumPackHeadgear, 696 },
            { PenetrationSuperiorPackHeadgear, 696 },
            // Penetration - Bag
            { PenetrationPrimaryPackBag, 237 }, { PenetrationMediumPackBag, 237 }, { PenetrationSuperiorPackBag, 237 },
            // Skill Critical Strike - Backsword
            { SkillCriticalStrikePrimaryPackBacksword, 1287 }, { SkillCriticalStrikeMediumPackBacksword, 1287 },
            { SkillCriticalStrikeSuperiorPackBacksword, 1287 },
            // Skill Critical Strike - Bracelet
            { SkillCriticalStrikePrimaryPackBracelet, 230 }, { SkillCriticalStrikeMediumPackBracelet, 230 },
            { SkillCriticalStrikeSuperiorPackBracelet, 230 },
            // Block - Shield
            ...
            // CriticalStrike - Bow
            { CriticalStrikePrimaryPackBow, 749 }, { CriticalStrikeMediumPackBow, 749 },
            { CriticalStrikeSuperiorPackBow, 749 },
            // CriticalStrike - 1 Handed weapons
            { CriticalStrikePrimaryPack1Handed, 751 }, { CriticalStrikeMediumPack1Handed, 751 },
            { CriticalStrikeSuperiorPack1Handed, 751 },
            // CriticalStrike - 2 Handed weapons
            { CriticalStrikePrimaryPack2Handed, 753 }, { CriticalStrikeMediumPack2Handed, 753 },
            { CriticalStrikeSuperiorPack2Handed, 753 },
            ...
            { DetoxicationPrimaryPackNecklace, 667 }, { DetoxicationMediumPackNecklace, 667 },
            { DetoxicationSuperiorPackNecklace, 667 },
            // Detoxication - Headgear
            { DetoxicationPrimaryPackHeadgear, 811 }, { DetoxicationMediumPackHeadgear, 811 },
            { DetoxicationSuperiorPackHeadgear, 811 },
            // Detoxication - Bag
            { DetoxicationPrimaryPackBag, 683 }, { DetoxicationMediumPackBag, 683 },
            { DetoxicationSuperiorPackBag, 683 },
            // Detoxication - Armor
            { DetoxicationPrimaryPackArmor, 813 }, { DetoxicationMediumPackArmor, 813 },
            { DetoxicationSuperiorPackArmor, 813 },
            // Detoxication - Boots
            { DetoxicationPrimaryPackBoots, 815 }, { DetoxicationMediumPackBoots, 815 },
            { DetoxicationSuperiorPackBoots, 815 },
            // Breakthrough - 1 Handed weapons
            { BreakthroughPrimaryPack1Handed, 789 }, { BreakthroughMediumPack1Handed, 789 },
            { BreakthroughSuperiorPack1Handed, 789 },
            // Breakthrough - 2 Handed weapons
            { BreakthroughPrimaryPack2Handed, 791 }, { BreakthroughMediumPack2Handed, 791 },
            { BreakthroughSuperiorPack2Handed, 791 },
            // Breakthrough - Bracelet
            { BreakthroughPrimaryPackBracelet, 162 }, { BreakthroughMediumPackBracelet, 162 },
            { BreakthroughSuperiorPackBracelet, 162 },
            // Breakthrough - Bow
            { BreakthroughPrimaryPackBow, 793 }, { BreakthroughMediumPackBow, 793 },
            { BreakthroughSuperiorPackBow, 793 },
            // Breakthrough - Ring
            { BreakthroughPrimaryPackRing, 266 }, { BreakthroughMediumPackRing, 266 },
            { BreakthroughSuperiorPackRing, 266 },
            // Counteraction - Armor
            { CounteractionPrimaryPackArmor, 331 }, { CounteractionMediumPackArmor, 331 },
            { CounteractionSuperiorPackArmor, 331 },
            // Counteraction - Bag
            { CounteractionPrimaryPackBag, 161 }, { CounteractionMediumPackBag, 161 },
            { CounteractionSuperiorPackBag, 161 },
            // Counteraction - Necklace
            { CounteractionPrimaryPackNecklace, 274 }, { CounteractionMediumPackNecklace, 274 },
            { CounteractionSuperiorPackNecklace, 274 },
            // Immunity - Boots
            ...
            { IntensificationPrimaryPackHeadgear, 301 }, { IntensificationMediumPackHeadgear, 301 },
            { IntensificationSuperiorPackHeadgear, 301 },
            // M-Defense - Necklace
            { MDefensePrimaryPackNecklace, 32 }, { MDefenseMediumPackNecklace, 32 },
            { MDefenseSuperiorPackNecklace, 32 },
            // M-Defense - Bag
            { MDefensePrimaryPackBag, 34 }, { MDefenseMediumPackBag, 34 }, { MDefenseSuperiorPackBag, 34 },
            // M-Defense - Bracelet
            { MDefensePrimaryPackBracelet, 36 }, { MDefenseMediumPackBracelet, 36 },
            { MDefenseSuperiorPackBracelet, 36 },
            // M-Defense - Ring
        ...
        public static void Handle(GameState client, ConquerItem item) {
            ...
            if (item.ID is >= RefineryPack724130 and <= RefineryPack725058 and (<= RefineryPack724135
                or >= RefineryPack724151 and <= RefineryPack724186
                or >= RefineryPack724190 and <= RefineryPack724192
                or >= RefineryPack725055 and <= RefineryPack725058)) {
                PacketHandler.GainRefineryItem(item, client);
                return;
            }

            // Handle items with offsets
            if (!ItemOffsets.TryGetValue(item.ID, out var offset)) return;
            ...
            switch (item.ID) {
                // Special cases
                case >= DetoxicationPrimaryPackNecklace and <= DetoxicationSuperiorPackNecklace: {
                    // Detoxication - Necklace
                    if (newItemId is 724348 or 724349)
                        newItemId += 150;
                    break;
                }
                case >= BreakthroughPrimaryPack1Handed and <= BreakthroughSuperiorPack1Handed: {
                    // Breakthrough - 1 Handed weapons
                    if (newItemId == 724449)
                        newItemId = 724445;
                    break;
                }
                case >= BreakthroughPrimaryPackRing and <= BreakthroughSuperiorPackRing: {
                    // Breakthrough - Ring
                    if (newItemId >= 724466)
                        newItemId += 4;
                    break;
