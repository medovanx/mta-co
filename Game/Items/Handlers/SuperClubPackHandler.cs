...
namespace MTA.Game.Items.Handlers {
    /// <summary>
    /// Handles SuperClubPack item that gives a Level 70 one Soc +5 Club, small Praying Stone (B), EXP Ball (B), and 5 EXP Potions.
    /// </summary>
    [ItemHandler(SuperClubPack)]
    public static class SuperClubPackHandler {
            ...
            if (client.Entity.Level >= 10) {
                if (client.Inventory.Count < 32) {
                    ...
                    items.Durability = items.MaximDurability =
                        ConquerItemInformation.BaseInformations[BronzeClub_Super].Durability;
