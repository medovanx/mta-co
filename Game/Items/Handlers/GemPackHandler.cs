        ...
        public static void Handle(GameState client, ConquerItem item) {
            ...
            switch (item.ID) {
                case RefinedGemBPack: {
                    ...
                    client.Send(new Message("Congratulations you have got a Refined gem!", Color.Red, Message.TopLeft));
                    break;
                }
                case SuperGemBPack: {
                    var gemId = nr switch {
                    ...
                    client.Send(new Message("Congratulations you have got a Super gem!", Color.Red, Message.TopLeft));
                    break;
                }
                case SuperGemPack when client.Inventory.Count > 38:
                case SuperGemPack when !client.Inventory.Contains(SuperGemPack, 1):
                    return;
                case SuperGemPack: {
