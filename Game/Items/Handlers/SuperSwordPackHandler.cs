...
namespace MTA.Game.Items.Handlers {
    /// <summary>
    /// Handles SuperSwordPack item that gives a Level 70 one Soc +5 Sword, small Praying Stone (B), EXP Ball (B), and 5 EXP Potions.
    /// </summary>
    [ItemHandler(SuperSwordPack)]
    public static class SuperSwordPackHandler {
