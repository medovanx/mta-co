...
namespace MTA.Game.Items.Handlers {
    /// <summary>
    /// Handles SuperShieldPack item that gives a Level 70 one Soc +5 Shield, small Praying Stone (B), EXP Ball (B), and 5 EXP Potions.
    /// </summary>
    [ItemHandler(SuperShieldPack)]
    public static class SuperShieldPackHandler {
            ...
            if (client.Entity.Level >= 10) {
                if (client.Inventory.Count < 32) {
                    ...
                    items.Durability = items.MaximDurability =
                        ConquerItemInformation.BaseInformations[WolfShield_Super].Durability;
