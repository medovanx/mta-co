...
namespace MTA.Game.Items.Handlers {
    /// <summary>
    /// Handles SuperBladePack item that gives a Level 70 one Soc +5 Blade, small Praying Stone (B), EXP Ball (B), and 5 EXP Potions.
    /// </summary>
    [ItemHandler(SuperBladePack)]
    public static class SuperBladePackHandler {
