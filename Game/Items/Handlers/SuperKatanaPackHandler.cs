...
namespace MTA.Game.Items.Handlers {
    /// <summary>
    /// Handles SuperKatanaPack item that gives a Level 70 one Soc +5 Katana, small Praying Stone (B), EXP Ball (B), and 5 EXP Potions.
    /// </summary>
    [ItemHandler(SuperKatanaPack)]
    public static class SuperKatanaPackHandler {
            ...
            if (client.Entity.Level >= 10) {
                if (client.Inventory.Count < 32) {
                    ...
                    items.Durability = items.MaximDurability =
                        ConquerItemInformation.BaseInformations[RainKatana_Super].Durability;
