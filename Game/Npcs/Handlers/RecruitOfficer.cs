                ...
                case 15: {
                    ...
                    if (client.Inventory.Count <= 30) {
                        //  if (client.Inventory.Contains(720356, 1))
                        {
                            ...
                            item2.ID = itemid2;
                            item2.Color = Enums.Color.White;
                            item2.Bound = true;
                            item2.Plus = 3;
                            item2.Durability = item2.MaximDurability =
                                ConquerItemInformation.BaseInformations[itemid2].Durability;
                            client.Inventory.Add(item2, Enums.ItemUse.CreateAndAdd);

                            ConquerItem item3 = new ConquerItem(true);
                            item3.ID = itemid3;
                            item3.Color = Enums.Color.White;
                            item3.Bound = true;
                            item3.Plus = 3;
                            item3.Durability = item3.MaximDurability =
                                ConquerItemInformation.BaseInformations[itemid3].Durability;
                            client.Inventory.Add(item3, Enums.ItemUse.CreateAndAdd);

                            ConquerItem item4 = new ConquerItem(true);
                            item4.ID = itemid4;
                            item4.Color = Enums.Color.White;
                            item4.Bound = true;
                            item4.Plus = 3;
                            item4.Durability = item4.MaximDurability =
                                ConquerItemInformation.BaseInformations[itemid4].Durability;
                            client.Inventory.Add(item4, Enums.ItemUse.CreateAndAdd);

                            ConquerItem item5 = new ConquerItem(true);
                            item5.ID = itemid5;
                            item5.Color = Enums.Color.White;
                            item5.Bound = true;
                            item5.Plus = 3;
                            item5.Durability = item5.MaximDurability =
                                ConquerItemInformation.BaseInformations[itemid5].Durability;
                            client.Inventory.Add(item5, Enums.ItemUse.CreateAndAdd);

                            ConquerItem item6 = new ConquerItem(true);
                            item6.ID = itemid6;
                            item6.Color = Enums.Color.White;
                            item6.Bound = true;
                            item6.Plus = 3;
                            item6.Durability = item6.MaximDurability =
                                ConquerItemInformation.BaseInformations[itemid6].Durability;
                            client.Inventory.Add(item6, Enums.ItemUse.CreateAndAdd);

                            ConquerItem item7 = new ConquerItem(true);
                            item7.ID = itemid7;
                            item7.Color = Enums.Color.White;
                            item7.Bound = true;
                            item7.Plus = 3;
                            item7.Durability = item7.MaximDurability =
                                ConquerItemInformation.BaseInformations[itemid7].Durability;
                            client.Inventory.Add(item7, Enums.ItemUse.CreateAndAdd);

                            ConquerItem item8 = new ConquerItem(true);
                            item8.ID = itemid8;
                            item8.Color = Enums.Color.White;
                            item8.Bound = true;
                            item8.Plus = 3;
                            item8.Durability = item8.MaximDurability =
                                ConquerItemInformation.BaseInformations[itemid8].Durability;
                            client.Inventory.Add(item8, Enums.ItemUse.CreateAndAdd);

                            ConquerItem item9 = new ConquerItem(true);
                            item9.ID = itemid9;
                            item9.Color = Enums.Color.White;
                            item9.Bound = true;
                            item9.Plus = 3;
                            item9.Durability = item9.MaximDurability =
                            ...
                            item10.ID = itemid10;
                            item10.Color = Enums.Color.White;
                            item10.Bound = true;
                            item10.Plus = 3;
                            ...
                            if (client.Inventory.Add(item, Enums.ItemUse.CreateAndAdd)) {
