...
namespace MTA.Game.Npcs.Handlers.Subclasses {
    ...
    /// </summary>
    [NpcHandler(355915)]
    public static class NpcLeadSage {
            ...
            switch (npcRequest.OptionID) {
                ...
                case 2:
                    if (!client.Entity.SubClasses.Classes.ContainsKey((byte)ClassID.Sage)) {
                        ...
                        dialog.Text(
                            "To promote to Phase " +
                            (client.Entity.SubClasses.Classes[(byte)ClassID.Sage].Phase + 1).ToString() +
                ...
                case 100:
                    if (PacketHandler.PassLearn((byte)ClassID.Sage, client.Entity)) {
                        client.Entity.SubClasses.Classes.Add((byte)ClassID.Sage,
                            new SubClass() { ID = (byte)ClassID.Sage, Level = 1, Phase = 1 });
                ...
                case 200:
                    ...
                    if (client.Entity.SubClasses.Classes[(byte)ClassID.Sage].Phase <
                        client.Entity.SubClasses.Classes[(byte)ClassID.Sage].Level) {
