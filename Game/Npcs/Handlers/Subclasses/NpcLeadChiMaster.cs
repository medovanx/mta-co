...
namespace MTA.Game.Npcs.Handlers.Subclasses {
    ...
    /// </summary>
    [NpcHandler(355910)]
    public static class NpcLeadChiMaster {
            ...
            switch (npcRequest.OptionID) {
                ...
                case 2:
                    if (!client.Entity.SubClasses.Classes.ContainsKey((byte)ClassID.ChiMaster)) {
                        ...
                        dialog.Text(
                            "To promote to Phase " +
                            (client.Entity.SubClasses.Classes[(byte)ClassID.ChiMaster].Phase + 1).ToString() +
                ...
                case 100:
                    if (PacketHandler.PassLearn((byte)ClassID.ChiMaster, client.Entity)) {
                        client.Entity.SubClasses.Classes.Add((byte)ClassID.ChiMaster,
                            new SubClass() { ID = (byte)ClassID.ChiMaster, Level = 1, Phase = 1 });
                ...
                case 200:
                    ...
                    if (client.Entity.SubClasses.Classes[(byte)ClassID.ChiMaster].Phase <
                        client.Entity.SubClasses.Classes[(byte)ClassID.ChiMaster].Level) {
