...
namespace MTA.Game.Npcs.Handlers.Subclasses {
    ...
    /// </summary>
    [NpcHandler(355916)]
    public static class NpcWrangler {
            ...
            switch (npcRequest.OptionID) {
                ...
                case 2:
                    if (!client.Entity.SubClasses.Classes.ContainsKey((byte)ClassID.Wrangler)) {
                        ...
                        dialog.Text(
                            "To promote to Phase " +
                            (client.Entity.SubClasses.Classes[(byte)ClassID.Wrangler].Phase + 1).ToString() +
                ...
                case 100:
                    if (PacketHandler.PassLearn((byte)ClassID.Wrangler, client.Entity)) {
                        client.Entity.SubClasses.Classes.Add((byte)ClassID.Wrangler,
                            new SubClass() { ID = (byte)ClassID.Wrangler, Level = 1, Phase = 1 });
                ...
                case 200:
                    ...
                    if (client.Entity.SubClasses.Classes[(byte)ClassID.Wrangler].Phase <
                        client.Entity.SubClasses.Classes[(byte)ClassID.Wrangler].Level) {
