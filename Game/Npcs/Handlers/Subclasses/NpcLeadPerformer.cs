...
namespace MTA.Game.Npcs.Handlers.Subclasses {
    ...
    /// </summary>
    [NpcHandler(355913)]
    public static class NpcLeadPerformer {
            ...
            switch (npcRequest.OptionID) {
                ...
                case 100:
                    if (PacketHandler.PassLearn((byte)ClassID.Performer, client.Entity)) {
                        client.Entity.SubClasses.Classes.Add((byte)ClassID.Performer,
                            new SubClass() { ID = (byte)ClassID.Performer, Level = 1, Phase = 1 });
                ...
                case 11: {
                    dialog.Text(
                        "I can help you learn unique dances. You must have the required sub-class and 5,000 CPs to learn each dance. Which dance would you like to learn?");
                ...
                case 200:
                    ...
                    if (client.Entity.SubClasses.Classes[(byte)ClassID.Performer].Phase <
                        client.Entity.SubClasses.Classes[(byte)ClassID.Performer].Level) {
