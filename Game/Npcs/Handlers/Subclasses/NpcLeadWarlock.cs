...
namespace MTA.Game.Npcs.Handlers.Subclasses {
    ...
    /// </summary>
    [NpcHandler(355914)]
    public static class NpcLeadWarlock {
            ...
            switch (npcRequest.OptionID) {
                ...
                case 2:
                    if (!client.Entity.SubClasses.Classes.ContainsKey((byte)ClassID.Warlock)) {
                        ...
                        dialog.Text(
                            "To promote to Phase " +
                            (client.Entity.SubClasses.Classes[(byte)ClassID.Warlock].Phase + 1).ToString() +
                ...
                case 100:
                    if (PacketHandler.PassLearn((byte)ClassID.Warlock, client.Entity)) {
                        client.Entity.SubClasses.Classes.Add((byte)ClassID.Warlock,
                            new SubClass() { ID = (byte)ClassID.Warlock, Level = 1, Phase = 1 });
                ...
                case 200:
                    ...
                    if (client.Entity.SubClasses.Classes[(byte)ClassID.Warlock].Phase <
                        client.Entity.SubClasses.Classes[(byte)ClassID.Warlock].Level) {
