...
namespace MTA.Game.Npcs.Handlers {
    ...
    /// </summary>
    [NpcHandler(44821140)]
    public static class SuperGuildWarPrizeClaimer {
        public static void Handle(GameState client, NpcRequest npcRequest, MTA.Npcs dialog) {
            switch (npcRequest.OptionID) {
                case 0: {
                    dialog.Text(
                        "Hello there! Would you like to claim your Super Guild War prize? You can only claim it once if you won the Super Guild War.");
                ...
                case 8: {
                    if (client.Guild != null) {
                        if (client.AsMember.Rank == GuildMemberRank.GuildLeader) {
                            ...
                            dialog.Text(
                                "Sorry, only the Guild Leader of the winning guild can claim the prize after the Super Guild War ends.");
                ...
                case 1: {
                    if (client.Guild != null) {
                        if (client.Guild.SuperPoleKeeper && client.Guild != null &&
                            ...
                            dialog.Text(
                                "Sorry, only the Super Guild Leader of the winning guild can claim the prize after the Super Guild War ends.");
                            dialog.Option("I understand", 255);
                            dialog.Send();
                        }
                    }
                ...
                case 2: {
                    if (!SuperGuildWar.IsWar && client.Guild.SuperPoleKeeper && SuperGuildWar.Claim &&
                        client.Guild != null && client.AsMember.Rank == GuildMemberRank.GuildLeader) {
                        ...
                        client.Entity.AddTopStatus(Update.Flags3.ConuqerSuperYellow, 3, DateTime.Now.AddDays(7));
                        Kernel.SendWorldMessage(
                            new Message(
                                "Congratulations! " + client.Entity.Name + ", Leader of " +
                                client.Guild.SuperPoleKeeper +
                                ", the winning guild, has claimed the Super Guild War Prize Lord Token!", Color.White,
                                Message.TopLeft), Program.Values);
                    }
                    else {
                        dialog.Text(
                            "Sorry, you don't have any prize to claim. Only the Guild Leader of the winning guild can claim the prize after the Super Guild War.");
                        dialog.Option("I understand", 255);
                        dialog.Send();
                    }
                ...
                case 3: {
                    if (client.Guild != null) {
                        if (client.Guild.SuperPoleKeeper && client.Guild != null &&
                            ...
                            dialog.Text(
                                "Sorry, only the Deputy Leader of the winning guild can claim the prize after the Super Guild War ends.");
                            dialog.Option("I understand", 255);
                            dialog.Send();
                        }
                    }
                    ...
                    if (!SuperGuildWar.IsWar && client.Guild.SuperPoleKeeper && client.Guild != null &&
                        ...
                        Kernel.SendWorldMessage(
                            new Message(
                                ...
                                ", the winning guild, has claimed the Top Deputy Leader Halo!", Color.White,
                                Message.TopLeft), Program.Values);
                    }
                    else {
                        dialog.Text(
                            "Sorry, you don't have any prize to claim. Only the Deputy Leader of the winning guild can claim the halo after the Super Guild War ends.");
                        dialog.Option("I understand", 255);
                        dialog.Send();
                    }
                ...
                case 6: {
                    if (client.Guild != null) {
                        if (client.Guild.SuperPoleKeeper && client.Guild != null &&
                            ...
                            dialog.Text(
                                "Sorry, only a Member Leader of the winning guild can claim the prize after the Super Guild War ends.");
                            dialog.Option("I understand", 255);
                            dialog.Send();
                        }
                    }
                ...
                case 7: {
                    if (!SuperGuildWar.IsWar && client.Guild.SuperPoleKeeper && client.Guild != null &&
                        ...
                        Kernel.SendWorldMessage(
                            new Message(
                                "Congratulations! " + client.Entity.Name + " from " + client.Guild.SuperPoleKeeper +
                                ", the winning guild, has claimed the Top Member Leader Title!", Color.White,
                                Message.TopLeft), Program.Values);
                    }
                    else {
                        dialog.Text(
                            "Sorry, you don't have any prize to claim. Only members of the winning guild can claim the halo after the Super Guild War ends.");
                        dialog.Option("I understand", 255);
                        dialog.Send();
                    }
