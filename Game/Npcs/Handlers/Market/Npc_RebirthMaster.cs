...
namespace MTA.Game.Npcs.Handlers.Market
{
    ...
    /// </summary>
    [NpcHandler(59558)]
    public static class Npc_RebirthMaster
    {
        ...
        public static void Handle(Client.GameState client, NpcRequest npcRequest, MTA.Npcs dialog)
        {
            switch (npcRequest.OptionID)
            {
                case 0:
                    {
                        dialog.Text("I have spent my whole life studying the changes of the universe, and I have finally understood the mystery of rebirth. As long as you reach level 90, you can embark on rebirth.");
                ...
                case 1:
                    {
                        if (client.Entity.Reborn == 0)
                        {
                            ...
                            {
                                dialog.Text("There are two kinds of rebirths. One is the normal one and the second one is blessed. The normal rebirth will give you the chance to get a Super Gem, and the blessed rebirth will set a -1 into one piece of equipment that you wear during the rebirth. What do you choose?");
                                            ...
                                            if (availableshots != 0)
                                            {
                                                ...
                                                if (!client.Equipment.Free(ex))
                                                    if (client.Equipment.TryGetItem(ex).Bless == 0)
                                                    {
                                                        ...
                                                        item.Send(client);
                                                        MTA.Database.ConquerItemTable.UpdateBless(item);
                                                    }
                                            }
                                        }
                                    }
                ...
                case 2:
                    {
                        ...
                        {
                            if (client.Entity.Class % 10 == MasterClassType && client.Entity.Level >= (client.Entity.Class == WaterSaintClassId ? WaterSaintRequiredLevel : OtherClassesRequiredLevel))
                            {
                            ...
                            {
                                dialog.Text("You need to be a master in your class and your level is 110+ for Water Saints or 120+ for other classes.");
                ...
                case 3:
                    {
                        ...
                        {
                            dialog.Text("I can help you change your class through, but first you need to have an Oblivion Dew in your inventory.");
                ...
                case 4:
                    {
                        dialog.Text("If you have got the first reborn and you misplaced your attribute points, or you want to set them another way, I'll reset your attribute points for one Dragon Ball. Do you accept?");
