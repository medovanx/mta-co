				...
				case 13:
					{
						...
						dialog.Text($"Are you sure you want to downgrade your house from level {currentLevel} to level {currentLevel - 1}?\nThis action is free but cannot be undone.");
				...
				case 14:
					{
						...
						House.DowngradeHouse(client, (byte)currentLevel);
