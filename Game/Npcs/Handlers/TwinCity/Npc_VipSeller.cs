                ...
                case 0:
                    {
                        ...
                        dialog.Text("You currently have " + client.Entity.ConquerPoints + " CPs.");
                ...
                case 1:
                    {
                        ...
                        {
                            dialog.Text("I'm sorry, but you cannot upgrade to this VIP level. You must upgrade sequentially from your current level.");
                            dialog.Option("Understood.", 255);
                            dialog.Avatar(116);
                            dialog.Send();
                        }
