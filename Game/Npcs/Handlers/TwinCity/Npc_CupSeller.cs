...
{
    /// <summary>
    /// Cup Seller NPC - Sells premium cups for CPs
    /// </summary>
    [NpcHandler(505444)]
    public static class Npc_CupSeller
    {
        public static void Handle(Client.GameState client, NpcRequest npcRequest, MTA.Npcs dialog)
        {
            ...
            switch (npcRequest.OptionID)
            {
                ...
                case 4:
                    {
                        dialog.Text($"The Holy Phoenix Cup costs {HOLY_PHOENIX_CUP_PRICE:N0} CPs. Would you like to purchase it?");
                ...
                case 13:
                    {
                        if (client.Entity.ConquerPoints >= HOLY_PHOENIX_CUP_PRICE)
                        {
                            ...
                            dialog.Text("Thank you for your purchase! The Holy Phoenix Cup has been added to your inventory.");
                            dialog.Option("Thank you!", 255);
                            dialog.Send();
                        }
                        else
