...
namespace MTA.Game.Npcs.Handlers.TwinCity.JobCenter
{
    ...
    /// </summary>
    [NpcHandler(4272)]
    public static class Npc_PirateMaster
    {
                ...
                case 0:
                    {
                        ...
                        {
                            dialog.Text("I am the master of the Pirate skills. The Pirate skills, are not skills that would make wounds but heal them. As I see, you started your way on conquering this world. I will try to help you teaching you warrior skills and promoting you.");
                ...
                case 80:
                    {
                        if (client.Entity.Class >= 70 && client.Entity.Class <= 75)
                        {
                            if (client.Entity.FirstRebornClass >= 72 && client.Entity.FirstRebornClass <= 75 && client.Entity.SecondRebornClass >= 72 && client.Entity.SecondRebornClass <= 75)
                            {
                            ...
                            {
                                dialog.Text("You are not allowed, I think you're not promoted yet or you're not pure Walter.");
                                dialog.Option("Thank you.", 255);
                                dialog.Send();
                            }
                        }
