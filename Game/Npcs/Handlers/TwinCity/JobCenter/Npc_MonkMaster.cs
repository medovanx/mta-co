...
namespace MTA.Game.Npcs.Handlers.TwinCity.JobCenter
{
    ...
    /// </summary>
    [NpcHandler(4271)]
    public static class Npc_MonkMaster
    {
                ...
                case 0:
                    {
                        ...
                        {
                            dialog.Text("Sorry, but I can only teach the monks of these lessons, we can not share our traditional knowledge to those who do not share the faith..");
                ...
                case 1:
                    {
                        if (client.Entity.Class >= 60 && client.Entity.Class <= 65)
                        {
                            ...
                            {
                                dialog.Text("Promoting now you need" + client.PromoteItemNameNeed + "level" + client.PromoteLevelNeed + ".");
                        ...
                        {
                            dialog.Text(". The ancient secrets of the monk is not to trade If you want to learn the secrets of the monk back in another life goodbye..");
                            dialog.Option("Okay.", 255);
                            dialog.Send();
                        }
                        break;
