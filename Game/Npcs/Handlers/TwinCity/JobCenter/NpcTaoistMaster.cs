...
namespace MTA.Game.Npcs.Handlers.TwinCity.JobCenter {
    ...
    /// </summary>
    [NpcHandler(10000)]
    public static class NpcTaoistMaster {
            ...
            switch (npcRequest.OptionID) {
                case 0: {
                    if (client.Entity.Class is >= 100 and <= 101) {
                        ...
                        if (client.Entity.Class >= mClass && client.Entity.Class <= MClass) {
                            dialog.Text(
                                "Every Taoist wants holy spirit and few gain. You`re gifted in controlling inner power. Just pay more attention to details, you may be the next achiever.");
                            ...
                            dialog.Text(
                                "The taoists` secrets are not to be trained to outsiders. Train elsewhere, master conqueror.");
                ...
                case 253: {
                    if (client.Entity.Class == 100) {
                        ...
                        dialog.Text("I will not tell any of the " + Classs +
                                    " secrets to another class, so, good bye.");
                        dialog.Option("Alright.", 255);
                        dialog.Send();
                    }
                ...
                case 1: {
                    if (client.Entity.Class >= mClass && client.Entity.Class <= MClass ||
                        client.Entity.Class >= mClasss && client.Entity.Class <= MClasss) {
                ...
                case 101: {
                    if (client.Entity.Class >= mClasss && client.Entity.Class <= MClasss) {
                        dialog.Text(
                            "i know many types of skills and spells for a true water taoist, like you! which of them do you want to learn, first ?.");
                ...
                case 15: {
                    if (client.Entity.Class >= mClasss && client.Entity.Class <= MClasss) {
                        dialog.Text(
                            "There are many Unique Skills and Spells available to those Who study the Path of water What whould you ask of me ?");
                ...
                case 102: {
                    if (client.Entity.Class >= 100) {
                        dialog.Text(
                            "Thunder and Cure are Two powerful arts that you are ready to practice. Should i teach you now ?");
                ...
                case 4: {
                    if (client.Entity.Class >= 100) {
                        dialog.Text(
                            "Only the most Powerful of taoists can master that are. [Fire Taoist, Level 80+] .");
                ...
                case 38: {
                    if (client.Entity.Class >= mClass && client.Entity.Class <= MClass) {
                        if (client.Entity.Level >= 81) {
                            if (client.Spells.ContainsKey(1001) && client.Spells[1001] != null &&
                                client.Spells[1001].Level == 3) {
                ...
                case 69: {
                    if (client.Entity.Class >= 100) {
                        dialog.Text(
                            "Before learning the Tornado spell, you must first parctice you fire spell. [Fire Spell 3rd Level+] .");
                        dialog.Option("I understand.", 255);
                        dialog.Send();
                    }
