...
namespace MTA.Game.Npcs.Handlers.TwinCity.JobCenter
{
    ...
    /// </summary>
    [NpcHandler(19634)]
    public static class Npc_WindwalkerMaster
    {
                ...
                case 6:
                    {
                        if (client.Entity.Class >= 160 && client.Entity.Class <= 165)
                        {
                            dialog.Text("Frost Gaze is an exclusive rebirth skill for Windwalker. The heroes who got reborn to be Windwalker can learn Frost Gaze I. If both of your precious and");
                ...
                case 10:
                    {
                        if (client.Entity.Class >= 160 && client.Entity.Class <= 165)
                        {
                            ...
                            {
                                dialog.Text("The study of [BurntFrost] requires FellowBrother to reach a certain level. FellowBrother, you can find me when you reach Level 15.");
                ...
                case 11:
                    {
                        if (client.Entity.Class >= 160 && client.Entity.Class <= 165)
                        {
                            ...
                            {
                                dialog.Text("The study of [HealingSnow] requires FellowBrother to reach a certain level. FellowBrother, you can find me when you reach Level 15.");
                                dialog.Option("I'll see you at Lv.15!", 2);
                                dialog.Avatar(333);
                                dialog.Send();
                            }
                ...
                case 12:
                    {
                        if (client.Entity.Class >= 160 && client.Entity.Class <= 165)
                        {
                            ...
                            {
                                dialog.Text("The study of [RageofWar] requires FellowBrother to reach a certain level. FellowBrother, you can find me when you reach Level 40.");
                ...
                case 13:
                    {
                        if (client.Entity.Class >= 160 && client.Entity.Class <= 165)
                        {
                            if (client.Entity.Level >= 40)
                            {
                                ...
                                {
                                    dialog.Text("FellowBrother has learned HorrorofStomper. Go practice and feel its power.");
                                    dialog.Option("Okay.", 255);
                                    dialog.Avatar(333);
                                    dialog.Send();
                            ...
                            {
                                dialog.Text("The study of [HorrorofStomper] requires FellowBrother to reach a certain level. FellowBrother, you can find me when you reach Level 40.");
                                dialog.Option("I'll see you at Lv.40!", 2);
                                dialog.Avatar(333);
                                dialog.Send();
                            }
                ...
                case 14:
                    {
                        if (client.Entity.Class >= 160 && client.Entity.Class <= 165)
                        {
                            ...
                            {
                                dialog.Text("The study of [ChillingSnow] requires FellowBrother to reach a certain level. FellowBrother, you can find me when you reach Level 70.");
                ...
                case 15:
                    {
                        if (client.Entity.Class >= 160 && client.Entity.Class <= 165)
                        {
                            if (client.Entity.Level >= 70)
                            {
                                ...
                                {
                                    dialog.Text("FellowBrother has learned PeaceofStomper. Go practice and feel its power.");
                                    dialog.Option("Okay.", 255);
                                    dialog.Avatar(333);
                                    dialog.Send();
                            ...
                            {
                                dialog.Text("The study of [PeaceofStomper] requires FellowBrother to reach a certain level. FellowBrother, you can find me when you reach Level 70.");
                                dialog.Option("I'll see you at Lv.70!", 2);
                                dialog.Avatar(333);
                                dialog.Send();
                            }
                ...
                case 17:
                    {
                        if (client.Entity.Class >= 160 && client.Entity.Class <= 165)
                        {
                            ...
                            {
                                dialog.Text("The study of [SwirlingStorm] requires FellowBrother to reach a certain level. FellowBrother, you can find me when you reach Level 15.");
                                dialog.Option("I'll see you at Lv.15!", 2);
                                dialog.Avatar(333);
                                dialog.Send();
                            }
                ...
                case 18:
                    {
                        if (client.Entity.Class >= 160 && client.Entity.Class <= 165)
                        {
                            if (client.Entity.Level >= 15)
                            {
                                ...
                                {
                                    dialog.Text("FellowBrother has learned ShadowofChaser. Go practice and feel its power.");
                                    dialog.Option("Okay.", 255);
                                    dialog.Avatar(333);
                                    dialog.Send();
                            ...
                            {
                                dialog.Text("The study of [ShadowofChaser] requires FellowBrother to reach a certain level. FellowBrother, you can find me when you reach Level 15.");
                                dialog.Option("I'll see you at Lv.15!", 2);
                                dialog.Avatar(333);
                                dialog.Send();
                            }
                ...
                case 19:
                    {
                        if (client.Entity.Class >= 160 && client.Entity.Class <= 165)
                        {
                            ...
                            {
                                dialog.Text("The study of [TripleBlasts] requires FellowBrother to reach a certain level. FellowBrother, you can find me when you reach Level 40.");
                                dialog.Option("I'll see you at Lv.40!", 2);
                                dialog.Avatar(333);
                                dialog.Send();
                            }
                ...
                case 20:
                    {
                        if (client.Entity.Class >= 160 && client.Entity.Class <= 165)
                        {
                            ...
                            {
                                dialog.Text("The study of [Thundercloud] requires FellowBrother to reach a certain level. FellowBrother, you can find me when you reach Level 70.");
                                dialog.Option("I'll see you at Lv.70!", 2);
                                dialog.Avatar(333);
                                dialog.Send();
                            }
                ...
                case 21:
                    {
                        if (client.Entity.Class >= 160 && client.Entity.Class <= 165)
                        {
                            ...
                            {
                                dialog.Text("The study of [Thunderbolt] requires FellowBrother to reach a certain level. FellowBrother, you can find me when you reach Level 100.");
                ...
                case 23:
                    {
                        if (client.Entity.Class >= 160 && client.Entity.Class <= 165)
                        {
                            ...
                            {
                                dialog.Text("The study of [Omnipotence] requires FellowBrother to reach a certain level. FellowBrother, you can find me when you reach Level 3.");
                ...
                case 24:
                    {
                        if (client.Entity.Class >= 160 && client.Entity.Class <= 165)
                        {
                            ...
                            {
                                dialog.Text("The study of [JusticeChant] requires FellowBrother to reach a certain level. FellowBrother, you can find me when you reach Level 3.");
                                dialog.Option("I'll see you at Lv.3!", 2);
                                dialog.Avatar(333);
                                dialog.Send();
                            }
                ...
                case 25:
                    {
                        if (client.Entity.Class >= 160 && client.Entity.Class <= 165)
                        {
                            ...
                            {
                                dialog.Text("The study of [RevengeTail] requires FellowBrother to reach a certain level. FellowBrother, you can find me when you reach Level 100.");
                                dialog.Option("I'll see you at Lv.100!", 2);
                                dialog.Avatar(333);
                                dialog.Send();
                            }
                ...
                case 26:
                    {
                        if (client.Entity.Class >= 160 && client.Entity.Class <= 165)
                        {
                            if (client.Entity.Level >= 100)
                            {
                                ...
                                {
                                    dialog.Text("FellowBrother has learned FreezingPelter. Go practice and feel its power.");
                                    dialog.Option("Okay.", 255);
                                    dialog.Avatar(333);
                                    dialog.Send();
                            ...
                            {
                                dialog.Text("The study of [FreezingPelter] requires FellowBrother to reach a certain level. FellowBrother, you can find me when you reach Level 100.");
                                dialog.Option("I'll see you at Lv.100!", 2);
                                dialog.Avatar(333);
                                dialog.Send();
                            }
