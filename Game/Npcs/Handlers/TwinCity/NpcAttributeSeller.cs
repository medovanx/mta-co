...
namespace MTA.Game.Npcs.Handlers.TwinCity {
    /// <summary>
    /// Attribute Seller - Provides Chi attribute modification, Perfection level enhancement, and Damage enhancement services
    /// </summary>
    [NpcHandler(888540)]
    public static class NpcAttributeSeller {
        // Service option IDs
        ...
        public static void Handle(GameState client, NpcRequest npcRequest, MTA.Npcs dialog) {
            switch (npcRequest.OptionID) {
                case 0: {
                    dialog.Text(
                        "Hello! I provide various enhancement services for your equipment and attributes. What would you like to do?");
                ...
                case 23: {
                    ...
                    dialog.Text("You have chosen Attribute [" + attributeSlot +
                                "]. Please select the attribute type you want to change it to.");
        ...
        private static void HandlePerfectionService(GameState client, MTA.Npcs dialog, int optionId) {
            if (optionId == PERFECTION_SERVICE || optionId == PERFECTION_MENU) {
                dialog.Text(
                    "Hello! I can enhance your equipment to Perfection Level 54. Most items cost 1,000,000 CPs, but Wings only cost 200 CPs. Which item would you like to enhance?");
        ...
        private static void HandleDamageService(GameState client, MTA.Npcs dialog, int optionId) {
            if (optionId == DAMAGE_SERVICE || optionId == DAMAGE_MENU) {
                dialog.Text(
                    "Hello! I can enhance your equipment with Damage (Bless +1) for 250,000 CPs. Which item would you like to enhance?");
        ...
        private static void HandleChiAttributeChange(GameState client, MTA.Npcs dialog, int optionId) {
            ...
            ChiTable.Sort((ChiPowerType)stage);
        ...
        private static void UpdateChiRankings(GameState client, ChiPowerType powerType) {
