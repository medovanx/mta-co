            ...
            switch (npcRequest.OptionID) {
                ...
                case 10: // Beginner Level (Safe)
                {
                    if (CpCastleEvent.IsEventActive()) {
                        ...
                        dialog.Text(
                            "The event runs every day at 14:00 and 20:00 Server Time and lasts for 30 minutes.");
                        dialog.Option("I see!", 255);
                        dialog.Avatar(31);
                        dialog.Send();
                    }
