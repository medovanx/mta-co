...
namespace MTA.Game.Npcs.Handlers.TwinCity {
    /// <summary>
    /// Player Utilities - Provides various utility services for players
    /// </summary>
    [NpcHandler(34227)]
    public static class NpcPlayerUtilities {
        ...
        public static void Handle(GameState client, NpcRequest npcRequest, MTA.Npcs dialog) {
            switch (npcRequest.OptionID) {
                ...
                case 8: {
                    ...
                    if (client.Entity.WTitles != null) {
                        using (var cmd = new MySqlCommand(MySqlCommandType.UPDATE)) {
                            cmd.Update("titles").Set("Points", titlePoints + client.Entity.WTitles.Points)
                ...
                case 21: // Change Gender
                {
                    ...
                    else if (BodyTypes.IsGirl(client.Entity.Body)) {
                ...
                case 25: // Small Girl (2001)
                {
                    ...
                    client.NobilityInformation.Gender = 0;
                    client.Entity.Spouse = "None";
                    client.Entity.Body = BodyTypes.GirlSmall;
                    client.NobilityInformation.Mesh = client.Entity.Mesh;
                    client.Equipment.UpdateEntityPacket();
                    if (oldBody != 0)
                        MTA.Game.Features.Flowers.Database.GenderMigrator.Migrate(client, oldBody);
