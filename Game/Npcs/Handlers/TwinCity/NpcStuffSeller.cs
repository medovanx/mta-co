...
namespace MTA.Game.Npcs.Handlers.TwinCity {
    /// <summary>
    /// Stuff Seller - Sells full equipment sets and special items
    /// </summary>
    [NpcHandler(225584)]
    public static class NpcStuffSeller {
        ...
        public static void Handle(GameState client, NpcRequest npcRequest, MTA.Npcs dialog) {
            switch (npcRequest.OptionID) {
                ...
                case 10: {
                    ...
                    steed.Durability = steed.MaximDurability =
                        ConquerItemInformation.BaseInformations[300000].Durability;
                    ...
                    var tower = new ConquerItem(true) {
                        ...
                        Plus = 12,
                        Bless = 1,
                        SocketOne = Enums.Gem.SuperGloryGem,
                        SocketTwo = Enums.Gem.SuperGloryGem
                    };
                    tower.Durability = tower.MaximDurability =
                        ConquerItemInformation.BaseInformations[202009].Durability;
                    ...
                    var fan = new ConquerItem(true) {
                        ...
                        Plus = 12,
                        Bless = 1,
                        SocketOne = Enums.Gem.SuperThunderGem,
                        SocketTwo = Enums.Gem.SuperThunderGem
                    };
                    fan.Durability = fan.MaximDurability = ConquerItemInformation.BaseInformations[201009].Durability;
                    AddItem(client, fan);
                    ...
                    wing.Durability = wing.MaximDurability = ConquerItemInformation.BaseInformations[204009].Durability;
                    AddItem(client, wing);
                    ...
                    crop.Durability = crop.MaximDurability = ConquerItemInformation.BaseInformations[203009].Durability;
                    AddItem(client, crop);
                    break;
                }
        ...
        /// </summary>
        private static bool CheckInventorySpace(GameState client, MTA.Npcs dialog, int requiredSlots) {
        ...
        /// </summary>
        private static ConquerItem CreateEpicItem(uint itemId, Enums.Gem socketGem = Enums.Gem.SuperDragonGem) {
            ...
            item.Durability = item.MaximDurability = ConquerItemInformation.BaseInformations[itemId].Durability;
            return item;
        }
        ...
        /// </summary>
        private static void AddItem(GameState client, ConquerItem item) {
