...
namespace MTA.Game.Npcs.Handlers.TwinCity {
    /// <summary>
    /// Steed Seller - Sells special +12 steeds for CPs
    /// </summary>
    [NpcHandler(34216)]
    public static class NpcSteedSeller {
            ...
            switch (npcRequest.OptionID) {
                ...
                default: {
                    ...
                    if (client.Entity.ConquerPoints >= STEED_PRICE) {
                        ...
                        PacketHandler.CheckCommand2("@tegotegatege Steed Fixed 12 0 0 0 0 " + colorParams, client);
