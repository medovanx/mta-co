            ...
            switch (npcRequest.OptionID) {
                ...
                case 2: {
                    dialog.Text("Hello " + client.Entity.Name +
                                "! Do you wish to be transported to the Elite Guild War arena?");
                ...
                case 3: {
                    dialog.Text("Hello " + client.Entity.Name +
                                "! Do you wish to be transported to the Guild War battlegrounds?");
                ...
                case 4: {
                    dialog.Text("Hello " + client.Entity.Name +
                                "! You can earn automatic CPs every 15 minutes by staying in Twin City. You'll receive 1,000,000 ConquerPoints and 1 OnlinePoint.");
                    dialog.Text(
                        "After 12 AM, the reward increases to 2,000,000 CPs every 15 minutes while in Twin City.");
                ...
                case 5: {
                    dialog.Text("Hello " + client.Entity.Name +
                                "! Do you wish to be transported to the tournament grounds?");
                ...
                case 7: {
                    dialog.Text("Hello " + client.Entity.Name +
                                "! Do you wish to be transported to the pole competition area?");
                ...
                case 50: {
                    client.Send(new Message("https://www.linkedin.com/in/medovanx", Color.Red, Message.Website));
                    break;
                }
            }
        }
