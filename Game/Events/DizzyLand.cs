...
namespace MTA.Game.Events {
    public class DizzyLand {
            ...
            Kernel.SendWorldMessage(
                new Message(
                    string.Concat(new object[] {
                        ...
                        " has won in " + War + " War and claimed 500 ConquerPoints!"
        ...
        public static void CloseSignUp() {
            Kernel.SendWorldMessage(
                new Message("You cant signup into " + War + " War Come again next Time!", Color.Red, Message.TopLeft),
                Program.Values);
            IsWar = false;
        }
        ...
        public static void End() {
            Kernel.SendWorldMessage(
                new Message(War + " War has been ended have fun in the next Time!", Color.Red, Message.TopLeft),
                Program.Values);
        }
    }
}