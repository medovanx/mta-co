...
namespace MTA.Game
{
    public class PoleDesert
    {
        ...
        public static void PoleDesertIni()
        {
        ...
        public static void Start()
        {
            ...
            name = new object[] { "Quest PoleDesert Has Started Go To Guild Controller At TwinCity (352,337)" };
            Kernel.SendWorldMessage(new Message(string.Concat(name), "ALLUSERS", "PoleDesert", System.Drawing.Color.Red, 2500), Program.Values);
            Kernel.SendWorldMessage(new Message("PoleDesert has began!", System.Drawing.Color.Red, Message.Center), Program.Values);
            FirstRound = true;
            ...
            Kernel.SendWorldMessage(upd, Program.Values, 2075);
            upd.Clear();
        ...
        public static void FinishRound()
        {
            ...
            if (PoleKeeper != null)
            {
                ...
                Kernel.SendWorldMessage(new Message("The guild, " + PoleKeeper.Name + ", owned by " + PoleKeeper.LeaderName + " has won this PoleDesert round!", System.Drawing.Color.Red, Message.Center), Program.Values);
            ...
            Pole.Hitpoints = Pole.MaxHitpoints;
            Kernel.SendWorldMessage(Pole, Program.Values, 2075);
            Reset();
        }
        ...
        public static void End()
        {
            if (PoleKeeper != null)
            {
                Kernel.SendWorldMessage(new Message("The guild, " + PoleKeeper.Name + ", owned by " + PoleKeeper.LeaderName + " has won this PoleDesert!---PoleDesert has ended!", System.Drawing.Color.White, Message.Center), Program.Values);
                //MTA.Database.EntityTable.Status2();  
            }
            else
            {
                Kernel.SendWorldMessage(new Message("PoleDesert has ended and there was no winner!", System.Drawing.Color.Red, Message.Center), Program.Values);
                //MTA.Database.EntityTable.Status2();  
            }
            IsWar = false;
            Claim = true;
        ...
        public static void SendScores()
        {
            ...
            for (int c = 0; c < scoreMessages.Length; c++)
            {
                ...
                Kernel.SendWorldMessage(msg, Program.Values, 2075);
