...
namespace MTA.Game
{
    public class PoleTwin
    {
        ...
        public static void Start()
        {
            ...
            Kernel.SendWorldMessage(upd, Program.Values, 2072);
            upd.Clear();
        ...
        public static void FinishRound()
        {
            ...
            Pole.Hitpoints = Pole.MaxHitpoints;
            Kernel.SendWorldMessage(Pole, Program.Values, 2072);
            Reset();
        }
        ...
        public static void SendScores()
        {
            ...
            for (int c = 0; c < scoreMessages.Length; c++)
            {
                ...
                Kernel.SendWorldMessage(msg, Program.Values, 2072);
