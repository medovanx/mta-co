...
namespace MTA.Game
{
    public class GuildWar
    {
        ...
        public static void Start()
        {
            ...
            Kernel.SendWorldMessage(upd, Program.Values, (ushort)1038);
            upd.Clear();
        ...
        public static void FinishRound()
        {
            ...
            Pole.Hitpoints = Pole.MaxHitpoints;
            Kernel.SendWorldMessage(Pole, Program.Values, (ushort)1038);
            Reset();
        }
        ...
        public static void End()
        {
            if (PoleKeeper != null)
            {
                Kernel.SendWorldMessage(new Message("The guild, " + PoleKeeper.Name + ", owned by " + PoleKeeper.LeaderName + " has won this guild war!---Guild war has ended!", System.Drawing.Color.White, Message.Center), Program.Values);
                //MTA.Database.EntityTable.Status2();
            }
            else
            {
                Kernel.SendWorldMessage(new Message("Guild war has ended and there was no winner!", System.Drawing.Color.Red, Message.Center), Program.Values);
                //MTA.Database.EntityTable.Status2();
            }
            IsWar = false;
            Claim = true;
        ...
        public static void SendScores()
        {
            ...
            for (int c = 0; c < scoreMessages.Length; c++)
            {
                ...
                Kernel.SendWorldMessage(msg, Program.Values, (ushort)1038);
