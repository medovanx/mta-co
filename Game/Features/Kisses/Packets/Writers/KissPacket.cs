...
namespace MTA.Game.Features.Kisses.Packets.Writers;
...
public class KissPacket : Writer, IPacket {
    ...
    public uint sub {
        get => System.BitConverter.ToUInt32(Buffer2, 4);
        set => WriteUInt32(value, 4, Buffer2);
    }

    public uint Amount {
        get => System.BitConverter.ToUInt32(Buffer2, 20);
        set => WriteUInt32(value, 20, Buffer2);
    }

    public KissType KissesType => (KissType)System.BitConverter.ToUInt32(Buffer2, 0x18);

    public uint ItemUID {
        get => System.BitConverter.ToUInt32(Buffer2, 12);
        set => WriteUInt32(value, 12, Buffer2);
    }

    public string ReceiverName {
        get => System.BitConverter.ToString(Buffer2, 32, 16);
        set => WriteString(value, 32, Buffer2);
    }

    public uint SendAmount {
        get => System.BitConverter.ToUInt32(Buffer2, 48);
        set => WriteUInt32(value, 48, Buffer2);
    }

    public string SenderName {
        get => System.BitConverter.ToString(Buffer2, 16, 16);
        set => WriteString(value, 16, Buffer2);
    }

    public KissType SendKissesType {
        get => (KissType)System.BitConverter.ToUInt32(Buffer2, 0x34);
        set => WriteUInt32((uint)value + 4, 52, Buffer2);
    }

    public uint UID1 {
        get => System.BitConverter.ToUInt32(Buffer2, 8);
        set => WriteUInt32(value, 8, Buffer2);
    }

    public uint remove {
        get => System.BitConverter.ToUInt32(Buffer2, 56);
        set => WriteUInt32(value, 56, Buffer2);
    }

    public uint UID2 {
        get => System.BitConverter.ToUInt32(Buffer2, 10);
