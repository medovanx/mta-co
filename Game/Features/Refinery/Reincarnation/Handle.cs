...
namespace Conquer_Online_Server.Game.Features.Reincarnation
{
    ...
    public class Reincarnation
    {
        ...
        public Reincarnation(Client.GameState client, byte new_class)
        {
            ...
            {
                WontAdd(Conquer_Online_Server.Game.Enums.SkillIDs.DragonFury);
            }
            ...
            {
                WontAdd(Conquer_Online_Server.Game.Enums.SkillIDs.StarFlashConuqer);
            }
            ...
            switch (client.Entity.FirstRebornClass)
            {
                case 15:
                    {
                        ...
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.SuperCyclone);
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.FatalCross);
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.MortalStrike);
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.BreathFocus);
                        break;
                    }
                case 25:
                    {
                ...
                case 55:
                    {
                        ...
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.TwilightDance);
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.SuperTwofoldBlade);
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.FatalSpin);
                ...
                case 85:
                    {
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.SpeedKick);
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.ViolentKick);
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.StormKick);
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.CrackingSwip);
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.SplittingSwipe);
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.DragonSwing);
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.DragonPunch);
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.DragonSlash);
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.DragonFlow);
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.DragonRoar);
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.DragonCyclone);
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.AirKick);
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.AirSweep);
                        Add(Conquer_Online_Server.Game.Enums.SkillIDs.AirRaid);
                        break;
                    }
                case 135:
                    {
            ...
            {
                Add(Conquer_Online_Server.Game.Enums.SkillIDs.DragonFury);
            }
            if (client.Entity.FirstRebornClass == 25 && client.Entity.SecondRebornClass == 25 &&
            ...
            {
                Add(Conquer_Online_Server.Game.Enums.SkillIDs.StarFlashConuqer);
            }
            if (client.Entity.FirstRebornClass == 55 && client.Entity.SecondRebornClass == 55 &&
                client.Entity.Class == 55)
            {
        ...
        private void Add(Conquer_Online_Server.Game.Enums.SkillIDs S)
        {
        ...
        private void WontAdd(Conquer_Online_Server.Game.Enums.SkillIDs S)
        {
                ...
                case 45:
                    {
                        switch (Second)
                        {
                            ...
                            default:
                                ...
                                WontAdd(Enums.SkillIDs.FlashConuqerRain);
