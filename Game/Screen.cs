...
namespace MTA.Game {
    public class Screen {
        ...
        private ConcurrentDictionary<uint, IMapObject> _objectDictionary;
        ...
        private static void monsterBuffersCallback(GameState client, int time) {
            ...
            if (client.Entity.StaminaStamp.Next(500, time: time)) {
                if (client.Vigor < client.MaxVigor) {
                    ushort amount = (ushort)(3 + (client.Entity.Action == Enums.ConquerAction.Sit ? 2 : 0));
                ...
                if (!client.Entity.ContainsFlag(Update.Flags.Ride) && !client.Entity.ContainsFlag(Update.Flags.Fly) ||
                    client.Equipment.TryGetItem(18) != null) {
                    int limit = 0;
                            ...
                            if (client.Entity.Dead && !client.Entity.ContainsFlag2(Update.Flags2.SoulShackle)) {
                                if (MyMath.Success(50.0)) {
                                    ...
                                    if (!client.Entity.ContainsFlag2(Update.Flags2.SoulShackle)) {
                                        client.Entity.AddFlag2(Update.Flags2
                                            .SoulShackle); //Give them shackeld effect                                                         
                                        client.Entity.ShackleStamp =
                                            Time32.Now; //Set stamp so source can remove the flag after X seconds
                                        client.Entity.ShackleTime =
                                            35; //(short)(30 + 15 * spell.Level);//double checking here. Could be db has this wrong.
                                    ...
                                    if (pet != null) {
                                        ...
                                        if (pet.Entity.Companion && !pet.Entity.Dead) {
                                            ...
                                            if (distance > distance2 ||
                                                client.Entity.ContainsFlag(Update.Flags.Invisibility) ||
                                                client.Entity.ContainsFlag(Update.Flags.Fly)) {
                                                if (monster.MonsterInfo.InSight == 0) {
                                                        ...
                                                        if (distance2 > Constants.pScreenDistance) {
                                                            ...
                                                            if (distance2 <= monster.MonsterInfo.AttackRange) {
                                                                if (Now >= monster.MonsterInfo.LastMove.AddMilliseconds(
                                                                        monster.MonsterInfo.AttackSpeed)) {
                                                                    monster.MonsterInfo.LastMove = Time32.Now;
                                                                    new Handle(null, monster, pet.Entity);
                                                                    if (Time32.Now >= monster.MonsterInfo.Lastpop
                                                                            .AddSeconds(30)) {
                                                                    ...
                                                                    if (distance2 < Constants.pScreenDistance) {
                                                                        if (Now >= monster.MonsterInfo.LastMove
                                                                            ...
                                                                            Enums.ConquerAngle facing =
                                                                                Kernel.GetAngle(monster.X, monster.Y,
                                                                                    pet.Entity.X, pet.Entity.Y);
                                                                            if (!monster.Move(facing)) {
                                                                                facing = (Enums.ConquerAngle)Kernel
                                                                                    .Random.Next(7);
                                                                                if (monster.Move(facing)) {
                                                                                    monster.Facing = facing;
                                                                                    GroundMovement move =
                                                                                        new GroundMovement(true);
                                                                                    move.Direction = facing;
                                                                                    move.UID = monster.UID;
                                                                                    move.GroundMovementType =
                                                                                        GroundMovement.Run;
                                                                                    monster.MonsterInfo
                                                                                        .SendScreen(move);
                                                                                    continue;
                                                                    ...
                                                                    if (Now >= monster.MonsterInfo.LastMove
                                                                        ...
                                                                        Enums.ConquerAngle facing =
                                                                            Kernel.GetAngle(monster.X, monster.Y,
                                                                                pet.Entity.X, pet.Entity.Y);
                                                                        if (!monster.Move(facing)) {
                                                                            facing = (Enums.ConquerAngle)Kernel.Random
                                                                                .Next(7);
                                                                            if (monster.Move(facing)) {
                                                                                monster.Facing = facing;
                                                                                GroundMovement move =
                                ...
                                if (monster.MonsterInfo.InSight == 0) {
                                    if (distance <= monster.MonsterInfo.ViewRange) {
                                        if (!client.Entity.ContainsFlag(Update.Flags.Invisibility)) {
                                            if (monster.MonsterInfo.SpellID != 0 ||
                                                !client.Entity.ContainsFlag(Update.Flags.Fly)) {
                                                monster.MonsterInfo.InSight = client.Entity.UID;
                                            }
                                        }
                                        ...
                                        if (distance > Constants.pScreenDistance) {
                                            ...
                                            if (distance <= monster.MonsterInfo.AttackRange) {
                                                if (client.Entity.ContainsFlag3(1UL << 53)) {
                                                    ...
                                                    var spell = SpellTable.GetSpell(12700, client);
                                                    foreach (var obj1 in client.Screen.Objects) {
                                                        if (Kernel.GetDistance(obj1.X, obj1.Y, obj.X, obj.Y) <= 8) {
                                                            if (obj1.MapObjType == MapObjectType.Monster ||
                                                                ...
                                                                if (Handle.CanAttack(client.Entity, attacked, spell,
                                                                        false)) {
                                                                    uint damage = Calculate.Melee(client.Entity,
                                                                    ...
                                                                    Handle.ReceiveAttack(client.Entity, attacked,
                                                                        attack, ref damage, spell);
                                                                }
                                                            }
                                                ...
                                                if (distance > monster.MonsterInfo.ViewRange / 2) {
                                                    if (distance < Constants.pScreenDistance) {
                                                        if (Now >= monster.MonsterInfo.LastMove.AddMilliseconds(
                                                            ...
                                                            Enums.ConquerAngle facing = Kernel.GetAngle(monster.X,
                                                                monster.Y, client.Entity.X, client.Entity.Y);
                                                            if (!monster.Move(facing)) {
                            ...
                            if (item.ItemID == FloorItem.DaggerStorm || item.ItemID == FloorItem.FuryofEgg ||
                                ...
                                if (item.Owner == client) {
                                    if (Time32.Now > item.UseTime.AddSeconds(1)) {
                                        ...
                                        var spell = SpellTable.GetSpell(11600, client);
                                            ...
                                            if (Kernel.GetDistance(obj1.X, obj1.Y, obj.X, obj.Y) <= 3) {
                                                if (obj1.MapObjType == MapObjectType.Monster ||
                                                    ...
                                                    if (Handle.CanAttack(client.Entity, attacked, spell, false)) {
                                                        uint damage = Calculate.Melee(client.Entity, attacked, spell,
                                                            ref attack);
                                                        ...
                                                        Handle.ReceiveAttack(client.Entity, attacked, attack,
                                                            ref damage, spell);
                                                    }
                                                }
                                                else if (obj1.MapObjType == MapObjectType.SobNpc) {
                                                    var attacked = obj1 as SobNpcSpawn;
                                                    if (Handle.CanAttack(client.Entity, attacked, spell)) {
                                                        uint damage = Calculate.Melee(client.Entity, attacked,
                                                            ref attack);
                                                        attack.Damage = damage;
                                                        attack.Attacked = attacked.UID;
                                                        attack.X = attacked.X;
                                                        ...
                                                        Handle.ReceiveAttack(client.Entity, attacked, attack, damage,
                                                            spell);
                                                    }
                                                }
                                            }
        ...
        public bool Add(IMapObject _object) {
        ...
        public bool Contains(IMapObject _object) {
            if (_object == null) return false;
        ...
        public void CleanUp(IPacket spawnWith) {
            bool remove;
            try {
        ...
        public void Reload(IPacket spawnWith = null) {
            try {
                ...
                foreach (Entity monster in Map.Entities.Values) {
                    if (monster == null) continue;
                    if (Kernel.GetDistance(monster.X, monster.Y, Owner.Entity.X, Owner.Entity.Y) <= 16 &&
                            ...
                            if (dist <= Constants.pScreenDistance && !Contains(pClient.Entity)) {
                                ...
                                if (pClient.Entity.InteractionInProgress &&
                                    ...
                                    if (pClient.Entity.Body == 1003 || pClient.Entity.Body == 1004) {
                                        ...
                                        if (Kernel.GamePool.ContainsKey(pClient.Entity.InteractionWith)) {
                                            GameState Cs = Kernel.GamePool[pClient.Entity.InteractionWith] as GameState;
                                            if (Cs.Entity.X == pClient.Entity.InteractionX &&
                                                pClient.Entity.Y == pClient.Entity.InteractionY) {
                                                Attack atak = new Attack(true);
                                                atak.Attacker = pClient.Entity.UID;
                                                atak.Attacked = pClient.Entity.InteractionWith;
                                ...
                                if (pClient.Entity.MyClones.Count > 0) {
                                    foreach (var clone in pClient.Entity.MyClones.Values) {
                                        ...
                                        if (Kernel.GetDistance(clone.X, clone.Y, Owner.Entity.X, Owner.Entity.Y) <=
                                            18 && !Contains(clone.UID)) {
                                            if (!clone.Dead)
                                ...
                                if (pClient.Pet.Pets.Count > 0) {
                                    foreach (var pet in pClient.Pet.Pets.Values) {
                                        ...
                                        if (Kernel.GetDistance(pet.Entity.X, pet.Entity.Y, Owner.Entity.X,
                                                Owner.Entity.Y) <= 18 && !Contains(pet.Entity.UID)) {
                                            if (!pet.Entity.Dead)
                ...
                if (Owner.Entity.MyClones.Count > 0) {
                    foreach (var clone in Owner.Entity.MyClones.Values) {
                        if (clone == null) continue;
                        if (Kernel.GetDistance(clone.X, clone.Y, Owner.Entity.X, Owner.Entity.Y) <= 18 &&
                            !Contains(clone.UID)) {
                            if (!clone.Dead)
                                clone.SendSpawn(Owner);
                        }
                ...
                if (Owner.Pet.Pets.Count > 0) {
                    foreach (var pet in Owner.Pet.Pets.Values) {
                        if (pet == null) continue;
                        if (pet.Entity == null) continue;
                        if (Kernel.GetDistance(pet.Entity.X, pet.Entity.Y, Owner.Entity.X, Owner.Entity.Y) <=
                            18 /* && !Contains(pet.Entity.UID)*/) {
                            if (!pet.Entity.Dead)
        ...
        public void SendScreen(IPacket buffer, bool self) {
            foreach (IMapObject _obj in Objects) {
                if (_obj != null) {
