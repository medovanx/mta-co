...
namespace MTA
{
    public class World
    {
        ...
        private void CharactersCallback(GameState client, int time)
        {
            ...
            #endregion
            #region Check = [Items]/By Magic.Coder
            #region integer
            ConquerItem d = client.Equipment.TryGetItem(ConquerItem.Tower);
            ConquerItem ds = client.Equipment.TryGetItem(ConquerItem.Fan);
            ConquerItem Head = client.Equipment.TryGetItem(ConquerItem.Head);
            ConquerItem Necklace = client.Equipment.TryGetItem(ConquerItem.Necklace);
            ConquerItem Armor = client.Equipment.TryGetItem(ConquerItem.Armor);
            ConquerItem RightWeapon = client.Equipment.TryGetItem(ConquerItem.RightWeapon);
            ConquerItem LeftWeapon = client.Equipment.TryGetItem(ConquerItem.LeftWeapon);
            ConquerItem Ring = client.Equipment.TryGetItem(ConquerItem.Ring);
            ConquerItem Boots = client.Equipment.TryGetItem(ConquerItem.Boots);
            ConquerItem SteedCrop = client.Equipment.TryGetItem(ConquerItem.SteedCrop);
            ConquerItem SteedWing = client.Equipment.TryGetItem(ConquerItem.Wing);
            #endregion
            #region Time Check
            ...
            {
                #region Cheack Damge
                #region StarTower - Damage
                if (!client.Equipment.Free(11) && PacketHandler.StarTower(client.Equipment.TryGetItem(11).ID))
                {
                    if (d.Bless > 1)
                    {
                ...
                #endregion
                #region HeavenFan - Damage
                if (!client.Equipment.Free(10) && PacketHandler.HeavenFan(client.Equipment.TryGetItem(10).ID))
                {
                    if (ds.Bless > 1)
                    {
                ...
                #endregion
                #region Necklace - Damage
                if (!client.Equipment.Free(2) && PacketHandler.Necklace(client.Equipment.TryGetItem(2).ID))
                {
                    if (Necklace.Bless > 7)
                    {
                ...
                #endregion
                #region Ring - Damage
                if (!client.Equipment.Free(6) && PacketHandler.Ring(client.Equipment.TryGetItem(6).ID))
                {
                    if (Ring.Bless > 7)
                    {
                ...
                #endregion
                #region Boots - Damage
                if (!client.Equipment.Free(7) && PacketHandler.Boots(client.Equipment.TryGetItem(7).ID))
                {
                    if (Boots.Bless > 7)
                    {
                ...
                #endregion
                #region SteedCrop - Damage
                if (!client.Equipment.Free(18) && PacketHandler.RidingCrop(client.Equipment.TryGetItem(18).ID))
                {
                    if (SteedCrop.Bless > 1)
                    {
                ...
                #endregion
                #region SteedWing - Damage
                if (!client.Equipment.Free(19) && PacketHandler.Wing(client.Equipment.TryGetItem(19).ID))
                {
                    if (SteedWing.Bless > 1)
                    {
                ...
                #endregion
                #endregion Anti[CHEAT] By Franko
                if (!Valid(client)) return;
