...
namespace MTA.Database
{
    ...
    public static class DataHolder
    {
        ...
        static ushort[] purifyStabilizationPoints = [10, 30, 60, 100, 150, 200];

        public static ushort RefineryStabilizationPoints(byte elevel)
        {
            return refineryStabilizationPoints[Math.Min(elevel - 1, 4)];
        }
        static ushort[] refineryStabilizationPoints = [10, 30, 70, 150, 270];

        public static ushort[] Disguises = [111, 224, 117, 152, 113, 833, 116, 245, 223, 112, 222, 114, 221, 115, 220];
        static ushort[] StonePoints = [1, 10, 40, 120, 360, 1080, 3240, 9720, 29160];
        static ushort[] ComposePoints = [20, 20, 80, 240, 720, 2160, 6480, 19440, 58320, 2700, 5500, 9000, 0];
        static byte[] _SteedSpeed = [0, 5, 10, 15, 20, 30, 40, 50, 65, 85, 90, 95, 100];
        static ushort[] TalismanExtra = [0, 6, 30, 70, 240, 740, 2240, 6670, 20000, 60000];
    }
}
