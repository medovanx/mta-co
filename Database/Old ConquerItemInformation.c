...
namespace Conquer_Online_Server.Database
{
            ...
            foreach (string line in baseText)
            {
                ...
                if (_item_.Length > 11)
                {
                    if (_item_.IndexOf("//", 0, 2) != 0)
                    {
                        ...
                        switch (CIBI.ID)
                        {
                            case 720650: CIBI.ConquerPointsWorth = 10000; break;
                            case 720651: CIBI.ConquerPointsWorth = 50000; break;
                            case 720652: CIBI.ConquerPointsWorth = 100000; break;
                            case 720671: CIBI.ConquerPointsWorth = 500000; break;
                            case 720672: CIBI.ConquerPointsWorth = 1000000; break;
                            case 720673: CIBI.ConquerPointsWorth = 2000000; break;
                        }
    ...
    public class ConquerItemBaseInformation
    {
        ...
        public void Parse(string Line)
        {
            ...
            Frequency = (byte)Convert.ToUInt16(data[17]);
