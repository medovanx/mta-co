namespace MTA.Database
{
    ...
    public class SkillTable
    {
        ...
        public static void LoadProficiencies(GameState client, MySqlConnection conn)
        {
            LoadProficiencies(client);
        }
        ...
        public static void LoadSpells(GameState client, MySqlConnection conn)
        {
            LoadSpells(client);
        }
        ...
        public static void SaveProficiencies(GameState client, MySqlConnection conn)
        {
            SaveProficiencies(client);
        }
        ...
        public static void SaveSpells(GameState client, MySqlConnection conn)
        {
            SaveSpells(client);
        }
    }
