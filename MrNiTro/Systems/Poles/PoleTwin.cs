...
namespace Conquer_Online_Server.Game
{
    public class PoleTwin
    {
        ...
        public static void Start()
        {
            ...
            Kernel.SendWorldMessage(new Message(string.Concat(name), "ALLUSERS", "PoleTwin", System.Drawing.Color.Red, 2500), Program.Values);
            Kernel.SendWorldMessage(new Message("PoleTwin has began!", System.Drawing.Color.Red, Message.Center), Program.Values);
            FirstRound = true;
        ...
        public static void FinishRound()
        {
            ...
            if (PoleKeeper != null)
            {
                ...
                Kernel.SendWorldMessage(new Message("The guild, " + PoleKeeper.Name + ", owned by " + PoleKeeper.LeaderName + " has won this PoleTwin round!", System.Drawing.Color.Red, Message.Center), Program.Values);
        ...
        public static void End()
        {
            if (PoleKeeper != null)
            {
                Kernel.SendWorldMessage(new Message("The guild, " + PoleKeeper.Name + ", owned by " + PoleKeeper.LeaderName + " has won this PoleTwin!---PoleTwin has ended!", System.Drawing.Color.White, Message.Center), Program.Values);
                //Conquer_Online_Server.Database.EntityTable.Status2();  
            }
            else
            {
                Kernel.SendWorldMessage(new Message("PoleTwin has ended and there was no winner!", System.Drawing.Color.Red, Message.Center), Program.Values);
                //Conquer_Online_Server.Database.EntityTable.Status2();  
            }
            IsWar = false;
            Claim = true;
