...
namespace Conquer_Online_Server.Game
{
    public class PhoneixPole
    {
        ...
        public static void PhoneixPoleIni()
        {
            var Map = Kernel.Maps[2073];
            Pole = (SobNpcSpawn)Map.Npcs[820];
        ...
        public static void Start()
        {
            ...
            name = new object[] { "Quest PhoneixPole Has Started Go To Guild Controller At TwinCity (352,337)" };
            Kernel.SendWorldMessage(new Message(string.Concat(name), "ALLUSERS", "PhoneixPole", System.Drawing.Color.Red, 2500), Program.Values);
            Kernel.SendWorldMessage(new Message("PhoneixPole has began!", System.Drawing.Color.Red, Message.Center), Program.Values);
            FirstRound = true;
        ...
        public static void FinishRound()
        {
            ...
            if (PoleKeeper != null)
            {
                ...
                Kernel.SendWorldMessage(new Message("The guild, " + PoleKeeper.Name + ", owned by " + PoleKeeper.LeaderName + " has won this PhoneixPole round!", System.Drawing.Color.Red, Message.Center), Program.Values);
        ...
        public static void End()
        {
            if (PoleKeeper != null)
            {
                Kernel.SendWorldMessage(new Message("The guild, " + PoleKeeper.Name + ", owned by " + PoleKeeper.LeaderName + " has won this PhoneixPole!---PhoneixPole has ended!", System.Drawing.Color.White, Message.Center), Program.Values);
                //Conquer_Online_Server.Database.EntityTable.Status2(); 
            }
            else
            {
                Kernel.SendWorldMessage(new Message("PhoneixPole has ended and there was no winner!", System.Drawing.Color.Red, Message.Center), Program.Values);
                //Conquer_Online_Server.Database.EntityTable.Status2(); 
            }
            IsWar = false;
            Claim = true;
