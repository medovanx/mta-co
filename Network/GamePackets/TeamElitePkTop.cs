    ...
    public class TeamElitePkTop : Writer {
        ...
        public TeamElitePkTop(TeamElitePk.GamePackets ID) {
            ...
            if (ID == TeamElitePk.GamePackets.SkillElitePkBrackets)
                WriteUInt16((ushort)TeamElitePk.GamePackets.SkillElitePkTop, 2, packet);
            else
                WriteUInt16((ushort)TeamElitePk.GamePackets.TeamElitePkTop, 2, packet);
        }
        ...
        public void Append(TeamElitePk.FighterStats stats, int rank) {
            ushort offset = (ushort)(20 + Index * 44);
            Index++;
