...
namespace MTA.Network.GamePackets.Roulette {
    public class MsgRouletteOpenGui : IPacket {
        ...
        public MsgRouletteTable.TableType Type {
            set { Writer.WriteUint((uint)value, 4, packet); }
        }

        public Color PlayerColor {
            set { Writer.Byte((byte)value, 8, packet); }
        }
        ...
        public void FinalizePacket(GameState user, Roulettes.RouletteTable.Member[] Members) {
