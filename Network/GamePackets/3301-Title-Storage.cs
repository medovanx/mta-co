...
namespace MTA.Network.GamePackets {
    public sealed class TitleStorage {
        ...
        public void AddTitle(GameState client, short _type, short _id, bool equipped = false) {
        ...
        public void Login(GameState client) {
            ...
            if (client.Entity.WTitles == null || client.Entity.WTitles.Data == null ||
                client.Entity.WTitles.Data.Length == 0) return;
    ...
    public class TitleStorageProto {
        [ProtoMember(1, IsRequired = true)] public TitleStorage.Action ActionId;

        [ProtoMember(4, IsRequired = true)] public int Id;

        [ProtoMember(2, IsRequired = true)] public int Points;

        [ProtoMember(3, IsRequired = true)] public int Type;

        [ProtoMember(5, IsRequired = true)] public TitleValue Value;
    }

    [ProtoContract]
    public class TitleValue {
        [ProtoMember(4, IsRequired = true)] public int dwParam4;

        [ProtoMember(3, IsRequired = true)] public bool Equipped;

        [ProtoMember(2, IsRequired = true)] public int Id;

        [ProtoMember(1, IsRequired = true)] public int Type;
    }
}