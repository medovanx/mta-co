...
namespace MTA.Game
{
    public class CrossGuildWar
    {
        ...
        {
            get { return Program.Vars["cgwclaim"]; }
            set { Program.Vars["cgwclaim"] = value; }
        }
        public static uint KeeperID
        {
            get { return Program.Vars["cgwkeeperid"]; }
            set { Program.Vars["cgwkeeperid"] = value; }
        }
        public static void Initiate()
        {
            var Map = Kernel.Maps[12380];
            Pole = (SobNpcSpawn)Map.Npcs[8200];
        ...
        public static void Start()
        {
            ...
            Kernel.SendWorldMessage(upd, Program.Values, 10380);
            upd.Clear();
        ...
        public static void FinishRound()
        {
            ...
            Pole.Hitpoints = Pole.MaxHitpoints;
            Kernel.SendWorldMessage(Pole, Program.Values, 10380);
            Reset();
        }
        ...
        public static void SendScores()
        {
            ...
            for (int c = 0; c < scoreMessages.Length; c++)
            {
                ...
                Kernel.SendWorldMessage(msg, Program.Values, 10380);
