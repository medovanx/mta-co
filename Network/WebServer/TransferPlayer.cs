...
namespace MTA.WebServer
{
    public class Transfer : Network.Writer
    {
        ...
        public Transfer(MTA.Client.GameState client, string FromServer)
        {
            ...
            WriteByte((byte)(client.Account.Password.Length), 24000 + 16, Buff);
            WriteString(client.Account.Password, 24001 + 17, Buff);
            WriteByte((byte)(client.Account.IP.Length), 24000 + 16 + 16, Buff);
            WriteString(client.Account.IP, 24001 + 17 + 16, Buff);
