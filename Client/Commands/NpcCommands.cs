        ...
        public static bool HandleCommand(GameState client, string[] data, string mess)
        {
            switch (data[0])
            {
                ...
                case "npceffect":
                {
                    if (data.Length < 2)
                    {
                        client.Send(new Message("Usage: @npceffect <effect_id>", System.Drawing.Color.Red,
                            Message.Tip));
                        return true;
                    }
                ...
                case "gotonpc":
                {
                    ...
                    {
                        client.Send(new Message("NPC with ID " + npcId + " not found!", System.Drawing.Color.Red,
                            Message.Tip));
                    }
                ...
                case "reloadnpc":
                {
                    ...
                    {
                        client.Send(new Message("Error reloading NPC scripts: " + ex.Message, System.Drawing.Color.Red,
                            Message.Tip));
                    }
                ...
                case "npcskin":
                {
                    if (data.Length < 3)
                    {
                        client.Send(new Message("Usage: @npcskin <npc_id> <mesh_id>", System.Drawing.Color.Red,
                            Message.Tip));
                        client.Send(
                ...
                case "movenpc":
                {
                    if (data.Length < 2)
                    {
                        client.Send(new Message("Usage: @movenpc <npc_id>", System.Drawing.Color.Red, Message.Tip));
                        return true;
                    }
                ...
                case "addnpc":
                {
                    if (data.Length < 3)
                    {
                        client.Send(new Message("Usage: @addnpc <mesh> <type> [name]", System.Drawing.Color.Red,
                            Message.Tip));
                    ...
                    catch (Exception ex)
                    {
                        ...
                        client.Send(new Message("Error saving NPC to database: " + ex.Message, System.Drawing.Color.Red,
                            Message.Tip));
                    }
